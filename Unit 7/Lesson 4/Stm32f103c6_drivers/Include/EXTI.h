...
typedef struct {
	...
	uint16_t 			EXTI_INPUT_LINE_NUM;	//@ref EXT_LINE_NUM_define
	GPIO_TypeDef 		*GPIO_PORT;
	uint16_t 			GPIO_PIN; 				//@ref GPIO_PINS_define in GPIO header
	uint8_t 			IVT_IRQ_NUM; 			//@ref IVT_IRQ_NUM_define in device header

} EXTI_GPIO_MAPPING_t;

typedef struct {

	EXTI_GPIO_MAPPING_t EXTI_PORT_PIN;  //@ref EXTI_PORT_PIN_define
