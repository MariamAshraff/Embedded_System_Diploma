...
#define GPIO_MODE_AF_INPUT					0x00000001u  //Alternate function input
...
void MCAL_GPIO_Init_Port_Range(GPIO_TypeDef *GPIOx, GPIO_PIN_CONFIG_t *PinConfig,uint8_t PinCount);
